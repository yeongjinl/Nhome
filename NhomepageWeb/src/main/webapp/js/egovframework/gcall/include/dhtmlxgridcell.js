...
function dhtmlXGridCellObject(obj){this.destructor=function(){this.cell.obj=null;this.cell=null;this.grid=null;this.base=null;return null};this.cell=obj;this.getValue=function(){if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
 ...
 this.editable=false};eXcell_corotxt.prototype=new eXcell_cotxt;function eXcell_cp(cell){try{this.cell=cell;this.grid=this.cell.parentNode.grid}catch (er){console.error('An error occurred while setting cell and grid:', er);};this.edit=function(){this.val=this.getValue()
 ...
 +";border:0px;'>&nbsp;</div>",
 val);this.cell.firstChild._bg=val};function eXcell_img(cell){try{this.cell=cell;this.grid=this.cell.parentNode.grid}catch (er){console.error('An error occurred while setting cell and grid:', er);
