                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20170424">2017.04.24 ~ 2018.01.28 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('151','제1콜센터 위탁운영')" onmouseout="fn_mouseOut('151')" rowspan="2" style="text-align: center;">
                                                                    	제1콜센터<br>위탁운영
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('155','제2콜센터 위탁운영')" onmouseout="fn_mouseOut('155')" style="text-align: center;">
                                                                    	제2콜센터<br>위탁운영
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('158','제2콜센터 시설임차')" onmouseout="fn_mouseOut('158')" style="text-align: center;">
                                                                    	제2콜센터<br>시설임차
                                                                </td>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('169','2. 제1에 따른 권리 행사는 개인정보보호법 시행규칙 별지 제8호 및 제11호 서식에 따라 작성 후 서면, 전자우편, 모사전송(팩스) 등을 통하여 하실 수 있으며, 110정부민원안내콜센터에서는 요구를 한 자가 본인이거나 정당한 대리인인지 확인합니다')" onmouseout="fn_mouseOut('169')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('345','1. 이 개인정보 처리방침은 2017.4.25(화)부터 적용됩니다')" onmouseout="fn_mouseOut('345')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2017.4.25(화)부터 적용됩니다.
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
