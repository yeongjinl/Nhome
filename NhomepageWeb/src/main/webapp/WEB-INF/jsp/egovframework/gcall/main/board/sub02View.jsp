            ...
            <main>
                <div class='contentArea' id='contentArea'>
                    <div class='limitWrap'>
                        ...
                        <div class='mainTitle'>보도자료</div>
                        
                        <table class='table table-bordered boardView'>
                            <caption class='blind'>보도자료 상세정보</caption>
                            <thead></thead>
                            <tbody>
                                <tr>
                                    <th>작성일</th>
                                    <td>${newsDetail.BOARD_REG_DATE}</td>

                                    <th>조회수</th>
                                    <td>${newsDetail.BOARD_VIEW}</td>
                                </tr>
                                ...
                                <tr>
                                    <th class='ttl'>제목</th>
                                    <td colspan="3" class='ttl'>${newsDetail.BOARD_TITLE}</td>
                                </tr>
                                
                                <tr>
                                    <td colspan="4" class='cont'>${newsDetail.BOARD_CONTENTS}</td>
                                </tr>
                                ...
                                <c:if test="${newsNext != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/board/newsView.do?num=${newsNext.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${newsNext.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                                <c:if test="${newsPrev != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/board/newsView.do?num=${newsPrev.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${newsPrev.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                        ...
                        <div class='text-center boardBtnWrap'>
                            <button type='button' class='btn' onclick="location.href='<c:url value='/board/news.do?curPage=${curPage}&scType=${scType}&scText=${scText}'/>'">목록</button>
                        </div>
