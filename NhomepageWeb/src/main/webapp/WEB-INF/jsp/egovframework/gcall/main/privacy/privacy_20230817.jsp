                ...
                <div class='contentArea' id='contentArea'><div class='container'>
                    ...
                    <div class='limitWrap'>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20230817">2023.06.01 ~ 2023.08.17 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tr>
                                                            <td tabindex="46" onmouseover="fn_mouseOver('46','보유기간 5년')" onmouseout="fn_mouseOut('46')" style="text-align: center;">보유기간</td>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th tabindex="94" onmouseover="fn_mouseOver('94','위탁업체')" onmouseout="fn_mouseOut('94')" scope="col">
																	위탁업체
                                                                </th>
                                                            </tr>
                                                        </thead>
                                            ...
                                            <tr>
                                                <td tabindex="98" onmouseover="fn_mouseOver('98','2 정부민원안내콜센터는 위탁계약 체결 시 개인정보보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적ㆍ관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리ㆍ감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다')" onmouseout="fn_mouseOut('98')" style="padding-left:20px">
                                                    ② 정부민원안내콜센터는 위탁계약 체결 시 개인정보보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적ㆍ관리적 보호조치, 재위탁 제한, 수탁자에 대한 <br class='pc__itemView'>
                                            ...
                                            <tr>
                                                <td style="padding-left:20px;font-size:18px;text-algin:center;">
                                                    ...
                                                    <img src="<c:url value='/images/egovframework/gcall/privacy/privacy04_1.png'/>" style="width:45px;hright:50px; vertical-align:middle;" alt="열람청구">
                                                    <b tabindex="112" onmouseover="fn_mouseOver('112','제5조 개인정보의 열람청구를 접수･처리하는 부서')" onmouseout="fn_mouseOut('112')">제5조(개인정보의 열람청구를 접수･처리하는 부서)</b><br> 
                                                </td>
                                                <tr>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td tabindex="136" onmouseover="fn_mouseOver('136','원유진')" onmouseout="fn_mouseOut('136')">&nbsp;원유진</td>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td tabindex="215" onmouseover="fn_mouseOver('215','02다시2110다시6511 접근권한자로 연결')" onmouseout="fn_mouseOut('215')" rowspan="3">&nbsp;02-2110-6511<br>※ 접근권한자로 연결</td>
                                            ...
                                            <tr>
                                                <td tabindex=237 onmouseover="fn_mouseOver('237','1 이 개인정보 처리방침은 2023.6.1(목)부터 적용됩니다')" onmouseout="fn_mouseOut('237')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2023.6.1(목)부터 적용됩니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td tabindex="238" onmouseover="fn_mouseOver('238','2 이전의 개인정보 처리방침은 개정내역에서 확인하실 수 있습니다')" onmouseout="fn_mouseOut('238')" style="padding-left:20px">
