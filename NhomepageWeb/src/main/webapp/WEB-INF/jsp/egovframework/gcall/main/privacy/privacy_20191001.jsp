                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20191001">2019.10.01 ~ 2020.04.19 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td onmouseover="fn_mouseOver('105','1년')" onmouseout="fn_mouseOut('105')">&nbsp;1년</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('106','화상(수화)상담')" onmouseout="fn_mouseOut('106')" colspan="2">&nbsp;<b>화상(수화)상담</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('107','처리목적')" onmouseout="fn_mouseOut('107')" style="text-align: center;">처리목적</td>
                                                            <td onmouseover="fn_mouseOver('108','화상(수화) 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('108')">&nbsp;화상(수화) 상담업무 처리 및 분석ㆍ관리</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('109','처리항목')" onmouseout="fn_mouseOut('109')" style="text-align: center;">처리항목</td>
                                                            <td onmouseover="fn_mouseOver('110','공통항목 : 연락처, 상담내용, 화상상담 영상, 아이피주소 추가항목 : 성명(타 기관으로 상담내용 처리이관 시)')" onmouseout="fn_mouseOut('110')">&nbsp;공통항목 : 연락처, 상담내용, 화상상담 영상, IP주소<br>
                                                                &nbsp;추가항목 : 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('111','처리근거')" onmouseout="fn_mouseOut('111')" style="text-align: center;">처리근거</td>
                                                            <td onmouseover="fn_mouseOver('112','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('112')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('113','보유기간')" onmouseout="fn_mouseOut('113')" style="text-align: center;">보유기간</td>
                                                            <td onmouseover="fn_mouseOver('114','1년')" onmouseout="fn_mouseOut('114')">&nbsp;1년</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('115','카카오톡 상담')" onmouseout="fn_mouseOut('115')" colspan="2">&nbsp;<b>카카오톡 상담</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('116','처리목적')" onmouseout="fn_mouseOut('116')" style="text-align: center;">처리목적</td>
                                                            <td onmouseover="fn_mouseOver('117','카카오톡 상담업무 처리 및 분석 관리')" onmouseout="fn_mouseOut('117')">&nbsp;카카오톡 상담업무 처리 및 분석ㆍ관리</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('118','처리항목')" onmouseout="fn_mouseOut('118')" style="text-align: center;">처리항목</td>
                                                            <td onmouseover="fn_mouseOver('119','공통항목 : 카카오톡 고객아이디(카카오톡아이디 아님), 상담내용 추가항목 : 연락처, 성명(타 기관으로 상담내용 처리이관 시)')" onmouseout="fn_mouseOut('119')">&nbsp;공통항목 : 카카오톡 고객ID(카카오톡ID 아님), 상담내용<br>
                                                                &nbsp;추가항목 : 연락처, 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('120','처리근거')" onmouseout="fn_mouseOut('120')" style="text-align: center;">처리근거</td>
                                                            <td onmouseover="fn_mouseOver('121','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('121')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('122','보유기간')" onmouseout="fn_mouseOut('122')" style="text-align: center;">보유기간</td>
                                                            <td onmouseover="fn_mouseOver('123','1년')" onmouseout="fn_mouseOut('123')">&nbsp;1년</td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot></tfoot>
                                                    </table>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('124','2. 처리한 개인정보는 정해진 목적 이외의 용도로는 이용되지 않으며, 목적이 변경될 경우 개인정보보호법 제18조에 따라 별도로 개인정보 주체에게 알리고 동의를 받을 예정입니다')" onmouseout="fn_mouseOut('124')" style="padding-left:20px">
                                                    ② 처리한 개인정보는 정해진 목적 이외의 용도로는 이용되지 않으며, 목적이 변경될 경우 개인정보보호법 제18조에 따라 별도로 개인정보 주체에게 알리고 동의를 받을 예정입니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('125','3. 국민콜110은 대국민 서비스 제공 및 민원처리 등 법령에서 정한 소관업무 수행의 목적에 필요한 최소한의 개인정보만을 처리합니다')" onmouseout="fn_mouseOut('125')" style="padding-left:20px">
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('226','고충상담기획과(110콜센터티에프)')" onmouseout="fn_mouseOut('226')">&nbsp;고충상담기획과(110콜센터T/F)</td>
                                                                <td onmouseover="fn_mouseOver('227','부서')" onmouseout="fn_mouseOut('227')" style="text-align: center;">부서</td>
                                                                <td onmouseover="fn_mouseOver('228','고충상담기획과(110콜센터티에프)')" onmouseout="fn_mouseOut('228')">&nbsp;고충상담기획과(110콜센터T/F)</td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('321','고충상담기획과(110콜센터티에프)')" onmouseout="fn_mouseOut('321')">&nbsp;고충상담기획과(110콜센터T/F)</td>
                                                                <td onmouseover="fn_mouseOver('322','부서')" onmouseout="fn_mouseOut('322')" style="text-align: center;">부서</td>
                                                                <td onmouseover="fn_mouseOver('323','고충상담기획과(110콜센터티에프)')" onmouseout="fn_mouseOut('323')">&nbsp;고충상담기획과(110콜센터T/F)</td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('359','1. 이 개인정보 처리방침은 2019.10.1(화)부터 적용됩니다')" onmouseout="fn_mouseOut('359')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2019.10.1(화)부터 적용됩니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td >
