...
<body>
	<table class='layout' summary="상담사연관리 등록">
			...
			<tr>
				...
				<td scope="col"  class='contentArea'>
					...
					<div class='page-title'>
						...
						<div class='navi'><i class='fa fa-home'></i> <i class='fa fa-chevron-right'></i> 게시물관리 <i class='fa fa-chevron-right'></i> <span class='now'>상담사연관리</span> <i class='fa fa-chevron-right'></i> <span class='now'>게시물 등록</span></div>
					</div>
					<div class="panel panel-default writeBox">
							<div class="panel-heading">게시물 등록</div>
						  	<div class="panel-body">
								<form  action="/consult/regProc.do" method="post">
							  		<table class='table table-bordered' summary="상담사연 등록을 나타냅니다.">
							  		<caption style="display:none">상담사연관리 등록</caption>
							  			<tbody>
								  			<tr>
							  				...
							  				<tr>
								  				...
								  				<td scope="col"  colspan=3>
								  				 	<input type='text' id="EMAIL" name="EMAIL" title="이메일"  class='form-control' placeholder="이메일을 입력해주세요" value="${fn:escapeXml(sUserEmail)}">
								  				</td>
								  			</tr>
							  				<tr>
							  					<th scope="col">내용</th>
												        ...
												        <div class="box-body">
												            ...
												            <label for="fileUp" class="fileDrop" title="파일첨부">
												                    ...
												                    <span>※ 동영상 첨부최대 용량 10MB / 첨부가능 확장자 .wmv .mp4 .avi .webm .ogg</span><br>
 																	<span> 이미지 첨부최대 용량 10MB / 첨부가능 확장자 .jpeg. png, .gif, .doc, .hwp, .ppt, .pptx, .xlsx, .pdf, .zip</span>												             
															</label>
					  		...
					  		<input type='hidden' id="CONFID" name="CONFID" value="9"/>
