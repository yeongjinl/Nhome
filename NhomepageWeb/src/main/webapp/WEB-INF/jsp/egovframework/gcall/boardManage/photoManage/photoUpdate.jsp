...
<body>
	<table class='layout' summary="포토갤러리 수정">
			...
			<td class='leftMenuArea'>
				...
				<td class='contentArea'>
					...
					<div class='page-title'>
						...
						<div class='navi'><i class='fa fa-home'></i> <i class='fa fa-chevron-right'></i> 게시물관리 <i class='fa fa-chevron-right'></i> <span class='now'>포토갤러리 관리</span> <i class='fa fa-chevron-right'></i> <span class='now'>게시물 수정</span></div>
					</div>
					<div class="panel panel-default writeBox">
						<div class="panel-heading">게시물 수정</div>
						  	<div class="panel-body">
							  	<form id="boardUpdProc" action="/photo/update.do" method="POST">
							  		<table class='table table-bordered' summary="포토갤러리 수정">
							  		<caption style="display: none">포토갤러리 수정</caption>
							  			<tbody>
							  				<tr>
							  		...
							  		<input type='hidden' id="CONFID" name="CONFID" value="5"/>
