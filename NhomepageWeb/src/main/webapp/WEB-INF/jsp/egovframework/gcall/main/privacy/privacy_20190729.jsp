                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20190729">2019.07.29 ~ 2019.09.30 적용지침</option>
                            ...
                            <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('71','처리근거')" onmouseout="fn_mouseOut('71')" style="text-align: center;">처리근거</td>
                                                                <td onmouseover="fn_mouseOver('72','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('72')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('73','보유기간')" onmouseout="fn_mouseOut('73')" style="text-align: center;">보유기간</td>
                                                                <td onmouseover="fn_mouseOver('74','1년')" onmouseout="fn_mouseOut('74')">&nbsp;1년</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('75','에스엔에스 상담')" onmouseout="fn_mouseOut('75')" colspan="2">&nbsp;<b>SNS상담</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('76','처리목적')" onmouseout="fn_mouseOut('76')" style="text-align: center;">처리목적</td>
                                                                <td onmouseover="fn_mouseOver('77','에스엔에스 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('77')">&nbsp;SNS 상담업무 처리 및 분석ㆍ관리</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('78','처리항목')" onmouseout="fn_mouseOut('78')" style="text-align: center;">처리항목</td>
                                                                <td onmouseover="fn_mouseOver('79','에스엔에스(페이스북, 트위터) 아이디, 상담내용')" onmouseout="fn_mouseOut('79')">&nbsp;SNS(페이스북, 트위터) ID, 상담내용</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('84','채팅상담')" onmouseout="fn_mouseOut('84')" colspan="2">&nbsp;<b>채팅상담</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('85','처리목적')" onmouseout="fn_mouseOut('85')" style="text-align: center;">처리목적</td>
                                                                <td onmouseover="fn_mouseOver('86','채팅 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('86')">&nbsp;채팅 상담업무 처리 및 분석ㆍ관리</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('87','처리항목')" onmouseout="fn_mouseOut('87')" style="text-align: center;">처리항목</td>
                                                                <td onmouseover="fn_mouseOver('88','공통항목 : 연락처, 상담내용, 아이피 주소 ,추가항목 : 성명(타 기관으로 상담내용 처리이관 시)')" onmouseout="fn_mouseOut('88')">&nbsp;공통항목 : 연락처, 상담내용, IP주소<br>
                                                                    &nbsp;추가항목 : 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('96','처리근거')" onmouseout="fn_mouseOut('96')" style="text-align: center;">처리근거</td>
                                                                <td onmouseover="fn_mouseOver('97','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('97')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('98','보유기간')" onmouseout="fn_mouseOut('98')" style="text-align: center;">보유기간</td>
                                                                <td onmouseover="fn_mouseOver('99','1년')" onmouseout="fn_mouseOut('99')">&nbsp;1년</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('100','화상(수화)상담')" onmouseout="fn_mouseOut('100')" colspan="2">&nbsp;<b>화상(수화)상담</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('101','처리목적')" onmouseout="fn_mouseOut('101')" style="text-align: center;">처리목적</td>
                                                                <td onmouseover="fn_mouseOver('102','화상(수화) 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('102')">&nbsp;화상(수화) 상담업무 처리 및 분석ㆍ관리</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('103','처리항목')" onmouseout="fn_mouseOut('103')" style="text-align: center;">처리항목</td>
                                                                <td onmouseover="fn_mouseOver('104','공통항목 : 연락처, 상담내용, 화상상담 영상, 아이피 주소 ,추가항목 : 성명(타 기관으로 상담내용 처리이관 시) ')" onmouseout="fn_mouseOut('104')">&nbsp;공통항목 : 연락처, 상담내용, 화상상담 영상, IP주소<br>
                                                                    &nbsp;추가항목 : 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('105','처리근거')" onmouseout="fn_mouseOut('105')" style="text-align: center;">처리근거</td>
                                                                <td onmouseover="fn_mouseOver('106','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('106')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('107','보유기간')" onmouseout="fn_mouseOut('107')" style="text-align: center;">보유기간</td>
                                                                <td onmouseover="fn_mouseOver('108','1년')" onmouseout="fn_mouseOut('108')">&nbsp;1년</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('109','카카오톡 상담')" onmouseout="fn_mouseOut('109')" colspan="2">&nbsp;<b>카카오톡 상담</b></td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('110','처리목적')" onmouseout="fn_mouseOut('110')" style="text-align: center;">처리목적</td>
                                                                <td onmouseover="fn_mouseOver('111','카카오톡 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('111')">&nbsp;카카오톡 상담업무 처리 및 분석ㆍ관리</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('112','처리항목')" onmouseout="fn_mouseOut('112')" style="text-align: center;">처리항목</td>
                                                                <td onmouseover="fn_mouseOver('113','공통항목 : 카카오톡 고객아이디(카카오톡아이디 아님), 상담내용 ,추가항목 : 연락처, 성명(타 기관으로 상담내용 처리이관 시)')" onmouseout="fn_mouseOut('113')">&nbsp;공통항목 : 카카오톡 고객ID(카카오톡ID 아님), 상담내용<br>
                                                                    &nbsp;추가항목 : 연락처, 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('114','처리근거')" onmouseout="fn_mouseOut('114')" style="text-align: center;">처리근거</td>
                                                                <td onmouseover="fn_mouseOver('115','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('115')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('116','보유기간')" onmouseout="fn_mouseOut('116')" style="text-align: center;">보유기간</td>
                                                                <td onmouseover="fn_mouseOver('117','1년')" onmouseout="fn_mouseOut('117')">&nbsp;1년</td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot></tfoot>
                                                    </table>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('151','비긴급 전산자원 유지관리')" onmouseout="fn_mouseOut('151')" style="text-align: center;">
                                                                    	비긴급<br>전산자원 <br> 유지관리
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('152','2019.7.9~2021.12.31')" onmouseout="fn_mouseOut('152')" style="text-align: center;">
                                                                    &nbsp;2019.7.9<br>~2021.12.31
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('153','업체 : ㈜아리시스 주소 : 서울특별시 금천구 가산디지털1로 145, 에이스하이엔드타워3 1102호 전화 : 02-2177-8100 근무시간 : 09:00~18:00(평일) 토ㆍ일요일 및 공휴일 휴무')" onmouseout="fn_mouseOut('153')">
                                                                    &nbsp;업체 : ㈜아리시스<br>
                                                                    &nbsp;주소 : 서울특별시 금천구 가산디지털1로 145, 에이스하이엔드타워3 1102호<br>
                                                                    &nbsp;전화 : 02-2177-8100<br>
                                                                    &nbsp;근무시간 : 09:00~18:00(평일)<br>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('154','상담사 위탁운영')" onmouseout="fn_mouseOut('154')" style="text-align: center;">
                                                                    	상담사<br>위탁운영
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('155','2019.4.1~2019.12.31')" onmouseout="fn_mouseOut('155')" style="text-align: center;">
                                                                    &nbsp;2019.4.1<br>~2019.12.31

                                                                </td>
                                                                <td onmouseover="fn_mouseOver('156','기관명 : ㈜한국코퍼레이션  주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동) 전화 : 02-3401-4114 근무시간 : 09:00~18:00(평일) 토ㆍ일요일 및 공휴일 휴무')" onmouseout="fn_mouseOut('156')">
                                                                    &nbsp;기관명 : ㈜한국코퍼레이션<br>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('189','상담안내과 (국민콜110티에프)')" onmouseout="fn_mouseOut('189')" rowspan="7" style="text-align: center;"> 상담안내과 <br>(국민콜110T/F) </td>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('200','02-2110-0679')" onmouseout="fn_mouseOut('200')" rowspan="7" style="text-align: center;"> 02-2110-0679 </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('206','카카오톡 상담')" onmouseout="fn_mouseOut('206')" style="text-align: center;"> 카카오톡 상담 </td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot></tfoot>
                                                    </table>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('207','8. 정보주체는 제1의 열람청구 접수ㆍ처리부서 이외에, 행정안전부의“개인정보보호 종합지원포털”웹사이트(www.privacy.go.kr)를 통하여서도 개인정보 열람청구를 하실 수 있습니다')" onmouseout="fn_mouseOut('207')" style="padding-left:20px">
                                                    ⑧ 정보주체는 제①의 열람청구 접수ㆍ처리부서 이외에, 행정안전부의“개인정보보호 종합지원포털”웹사이트(www.privacy.go.kr)를 통하여서도 개인정보 열람청구를 하실 수 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('208','9. 정보주체 권리에 따른 열람의 요구, 정정ㆍ삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다')" onmouseout="fn_mouseOut('208')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('209','5. 개인정보보호 책임자')" onmouseout="fn_mouseOut('209')">
                                                    <b>5. 개인정보보호 책임자</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('210','국민콜110은 개인정보 처리에 관한 업무를 책임지고 정보주체의 불만 또는 피해구제 등을 위하여 다음과 같이 개인정보보호 책임자 및 담당자를 지정하고 있습니다')" onmouseout="fn_mouseOut('210')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th onmouseover="fn_mouseOver('211','개인정보보호 책임자')" onmouseout="fn_mouseOut('211')" scope="col" colspan="2" >개인정보보호 책임자</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('222','전시현')" onmouseout="fn_mouseOut('222')">&nbsp;전시현</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('226','상담안내과(110콜센터티에프)')" onmouseout="fn_mouseOut('226')">&nbsp;상담안내과(110콜센터T/F)</td>
                                                                <td onmouseover="fn_mouseOver('227','부서')" onmouseout="fn_mouseOut('227')" style="text-align: center;">부서</td>
                                                                <td onmouseover="fn_mouseOver('228','상담안내과(110콜센터티에프)')" onmouseout="fn_mouseOut('228')">&nbsp;상담안내과(110콜센터T/F)</td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('241','주무관')" onmouseout="fn_mouseOut('241')">&nbsp;주무관</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('247','02-2110-0679')" onmouseout="fn_mouseOut('247')">&nbsp;02-2110-0679</td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <span onmouseover="fn_mouseOver('268','1. 관리적 조치 : 내부관리계획 수립ㆍ시행, 정기적 직원 교육 등')" onmouseout="fn_mouseOut('268')" style="padding-left:25px">1. 관리적 조치 : 내부관리계획 수립ㆍ시행, 정기적 직원 교육 등</span><br>
                                                    <span onmouseover="fn_mouseOver('269','2. 기술적 조치 : 접근권한 관리, 주요정보 암호화, 보안프로그램 설치 등')" onmouseout="fn_mouseOut('269')" style="padding-left:25px">2. 기술적 조치 : 접근권한 관리, 주요정보 암호화, 보안프로그램 설치 등 </span><br>
                                                    <span onmouseover="fn_mouseOver('270','3. 물리적 조치 : 전산실 등의 접근통제')" onmouseout="fn_mouseOut('270')" style="padding-left:25px">3. 물리적 조치 : 전산실 등의 접근통제 </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td >
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('280','8. 정보주체의 권익침해 구제방법')" onmouseout="fn_mouseOut('280')">
                                                    <b>8. 정보주체의 권익침해 구제방법</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('281','1. 정보주체는 아래의 기관으로 개인정보 침해에 대한 피해구제, 상담 등을 하실 수 있습니다')" onmouseout="fn_mouseOut('281')" style="padding-left:20px">
                                                    ① 정보주체는 아래의 기관으로 개인정보 침해에 대한 피해구제, 상담 등을 하실 수 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span onmouseover="fn_mouseOver('282','1. 개인정보보호 종합포털 : 국번없이 118(프라이버시점기사점오알점케이알)')" onmouseout="fn_mouseOut('282')" style="padding-left:25px">1. 개인정보보호 종합포털 : 국번없이 118(privacy.kisa.or.kr) </span><br>
                                                    <span onmouseover="fn_mouseOver('283','2. 대검찰청 사이버범죄수사단 : 02-3480-3571(사이버시드골뱅이에스피오점지오점케이알)')" onmouseout="fn_mouseOut('283')" style="padding-left:25px">2. 대검찰청 사이버범죄수사단 : 02-3480-3571(cybercid@spo.go.kr) </span><br>
                                                    <span onmouseover="fn_mouseOver('284','3. 경찰청 사이버테러대응센터 : 1566-0112(떠블떠블떠블점네탄점지오점케이알)')" onmouseout="fn_mouseOut('284')" style="padding-left:25px">3. 경찰청 사이버테러대응센터 : 1566-0112(www.netan.go.kr) </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('285','2. 또한, 개인정보의 열람, 정정, 삭제, 처리정지 등에 대한 정보주체의 요구에 대한 처분 또는 부작위로 인하여 권리 또는 이익을 침해받은 경우, 행정심판법이 정하는 바에 따라 행정심판(더블더블더블점심판점지오점케이알)을 청구할 수 있습니다')" onmouseout="fn_mouseOut('285')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('286','9. 영상정보처리기기 설치 및 운영')" onmouseout="fn_mouseOut('286')">
                                                    <b>9. 영상정보처리기기 설치 및 운영</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('287','1. 국민콜110은 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다')" onmouseout="fn_mouseOut('287')" style="padding-left:20px">
                                                    ① 국민콜110은 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('288','1. 설치목적 : 국민콜110 전산실 안전 및 화재예방 등')" onmouseout="fn_mouseOut('288')">
                                                    <span style="padding-left:25px">1. 설치목적 : 국민콜110 전산실 안전 및 화재예방 등 </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('289','2. 설치대수 : 3대')" onmouseout="fn_mouseOut('289')">		
                                                    <span style="padding-left:25px">2. 설치대수 : 3대 </span><br>
                                                </td>
                                            </tr>
                                            <tr>	
                                                <td onmouseover="fn_mouseOver('290','3. 설치위치 : 국민콜110 전산실')" onmouseout="fn_mouseOut('290')">	
                                                    ...
                                                    <table class='table table-bordered' >
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('308','전시현')" onmouseout="fn_mouseOut('308')">&nbsp;전시현</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('321','상담안내과(110콜센터티에프)')" onmouseout="fn_mouseOut('321')">&nbsp;상담안내과(110콜센터T/F)</td>
                                                                <td onmouseover="fn_mouseOver('322','부서')" onmouseout="fn_mouseOut('322')" style="text-align: center;">부서</td>
                                                                <td onmouseover="fn_mouseOver('323','상담안내과(110콜센터티에프)')" onmouseout="fn_mouseOut('323')">&nbsp;상담안내과(110콜센터T/F)</td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('327','주무관')" onmouseout="fn_mouseOut('327')">&nbsp;주무관</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('328','연락처')" onmouseout="fn_mouseOut('328')" rowspan="3" style="text-align: center;">연락처</td>
                                                                <td onmouseover="fn_mouseOver('329','02-2110-6502 개인정보보호 담당자로 연결')" onmouseout="fn_mouseOut('329')" rowspan="3">&nbsp;02-2110-6502<br>※ 개인정보보호 담당자로 연결</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('351','02-2110-0679')" onmouseout="fn_mouseOut('351')">&nbsp;02-2110-0679</td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('358','10. 개인정보 처리방침의 변경')" onmouseout="fn_mouseOut('358')">
                                                    <b>10. 개인정보 처리방침의 변경</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('359','1. 이 개인정보 처리방침은 2019.7.29(월)부터 적용됩니다')" onmouseout="fn_mouseOut('359')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2019.7.29(월)부터 적용됩니다.
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
