                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20160822">2016.08.22 ~ 2016.09.29 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('130','3. 110정부민원안내콜센터는 대국민 서비스 제공 및 민원처리 등 법령에서 정한 소관업무 수행의 목적에 필요한 최소한의 개인정보만을 처리합니다')" onmouseout="fn_mouseOut('130')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('132','1. 110정부민원안내콜센터는 원칙적으로 명시한 범위 내에서 개인정보를 처리하며, 정보주체의 사전 동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다')" onmouseout="fn_mouseOut('132')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('135','1. 110정부민원안내콜센터는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다')" onmouseout="fn_mouseOut('135')" style="padding-left:20px">
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('140','2016.3.1 에서 2016.12.31')" onmouseout="fn_mouseOut('140')" style="text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('143','2015.2.1 에서 2016.12.31')" onmouseout="fn_mouseOut('143')" rowspan="2" style="text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('147','2016.6.1. 에서 2018.12.31')" onmouseout="fn_mouseOut('147')" style="text-align: center;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('150','2016.6.1. 에서 2018.12.31')" onmouseout="fn_mouseOut('150')" style="text-align: center;">
                                                                    &nbsp;2016.6.1.<br>~2018.12.31
                                                                </td>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('266','110정부민원안내제1콜센터')" onmouseout="fn_mouseOut('266')" style="text-align: center;">110정부민원안내제1콜센터</td>
                                                                <td onmouseover="fn_mouseOver('267','3대')" onmouseout="fn_mouseOut('267')" style="text-align: center;">3대</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('268','110정부민원안내제2콜센터')" onmouseout="fn_mouseOut('268')" style="text-align: center;">110정부민원안내제2콜센터</td>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('282','110정부민원안내제1콜센터')" onmouseout="fn_mouseOut('282')" style="text-align: center;">110정부민원안내제1콜센터</td>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('285','110정부민원안내제2콜센터')" onmouseout="fn_mouseOut('285')" style="text-align: center;" rowspan="2">110정부민원안내제2콜센터</td>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('302','110정부민원안내제1콜센터')" onmouseout="fn_mouseOut('302')" style="text-align: center;">110정부민원안내제1콜센터</td>
                                                                <td onmouseover="fn_mouseOver('303','전산실 입구')" onmouseout="fn_mouseOut('303')" style="text-align: center;">전산실 입구</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('304','110정부민원안내제2콜센터')" onmouseout="fn_mouseOut('304')" style="text-align: center;" rowspan="2">110정부민원안내제2콜센터</td>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('320','110정부민원안내제1콜센터')" onmouseout="fn_mouseOut('320')" style="text-align: center;">110정부민원안내제1콜센터</td>
                                                                <td onmouseover="fn_mouseOver('321','22일')" onmouseout="fn_mouseOut('321')" style="text-align: center;">22일</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('322','110정부민원안내제2콜센터')" onmouseout="fn_mouseOut('322')" style="text-align: center;">110정부민원안내제2콜센터</td>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('327','110정부민원안내제1콜센터')" onmouseout="fn_mouseOut('327')" style="text-align: center;">110정부민원안내제1콜센터</td>
                                                                <td onmouseover="fn_mouseOver('328','전산실(6층)')" onmouseout="fn_mouseOut('328')" style="text-align: center;">전산실(6층)</td>
                                                            </tr>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('329','110정부민원안내제2콜센터')" onmouseout="fn_mouseOut('329')" style="text-align: center;">110정부민원안내제2콜센터</td>
                                            ...
                                            <tr>	
                                                <td onmouseover="fn_mouseOver('340','8. 관리책임 : 110정부민원안내콜센터장')" onmouseout="fn_mouseOut('340')">	
                                                    <span style="padding-left:25px">8. 관리책임 : 110정부민원안내콜센터장 </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td >
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('345','1. 이 개인정보 처리방침은 2016.8.22(월)부터 적용됩니다')" onmouseout="fn_mouseOut('345')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2016.8.22(월)부터 적용됩니다.
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
