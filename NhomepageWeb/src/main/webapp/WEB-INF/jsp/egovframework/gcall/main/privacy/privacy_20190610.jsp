                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20190610">2019.06.10 ~ 2019.07.28 적용지침</option>
                            ...
                            <div class="panel-body ">
                                    <table>
                                        ...
                                        <thead class='blind'><tr><th scope='col'>개인정보처리방침</th></tr></thead>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('151','상담사 위탁운영')" onmouseout="fn_mouseOut('151')" style="text-align: center;">
                                                                    	상담사<br>위탁운영
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('152','2019.4.1~2019.12.31')" onmouseout="fn_mouseOut('152')" style="text-align: center;">
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('189','상담안내과 (국민콜110티에프)')" onmouseout="fn_mouseOut('189')" rowspan="6" style="text-align: center;"> 상담안내과 <br>(국민콜110T/F) </td>
                                                                <td onmouseover="fn_mouseOver('190','02-2110-6502')" onmouseout="fn_mouseOut('190')" rowspan="6" style="text-align: center;"> 02-2110-6502 </td>
                                                                <td onmouseover="fn_mouseOver('200','02-2110-0679')" onmouseout="fn_mouseOut('200')" rowspan="6" style="text-align: center;"> 02-2110-0679 </td>
                                                            </tr>
                                                            <tr>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('206','8. 정보주체는 제1의 열람청구 접수ㆍ처리부서 이외에, 행정안전부의“개인정보보호 종합지원포털”웹사이트(www.privacy.go.kr)를 통하여서도 개인정보 열람청구를 하실 수 있습니다')" onmouseout="fn_mouseOut('206')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('359','1. 이 개인정보 처리방침은 2019.6.10(월)부터 적용됩니다')" onmouseout="fn_mouseOut('359')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2019.6.10(월)부터 적용됩니다.
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
