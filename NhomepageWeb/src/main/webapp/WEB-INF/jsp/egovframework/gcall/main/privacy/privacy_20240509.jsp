                ...
                <div class='contentArea' id='contentArea'><div class='container'>
                    ...
                    <div class='limitWrap'>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20240509">2024.04.15 ~ 2024.05.08 적용지침</option>
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td tabindex="36" onmouseover="fn_mouseOver('36','필수 : 연락처, 상담내용, 상담내용 녹취 _ 선택 : 성명, 주소, 신고내용(긴급신고 이관 시), 접수내용(비긴급상담 이관ㆍ접수 시) _ 선택 : 생년월일, 주소지, 가족성명, 보훈번호(국가보훈부 상담 시) _ 선택 : 성명, 성별, 지역(또는 주소), 연령대(행정안전부 관련상담 시) _ 선택 : 성명, 대리인(또는 법인명), 사건·접수번호, 처분청, 연락처(행정심판 상담 시) _ 선택 : 성명, 영업장명, 영업장주소(식품의약품안전처 상담 시) _ 선택 : 상호, 대표자명, 사업자등록번호(공정거래위원회 상담 시) _ 선택 : 성명, 조사지역(통계청 상담 시) _ 선택 : 성명, 소속기관, 이메일주소, 생년월일(청렴연수원 나라배움터 상담 시) _ 선택 : 문서24 ID, 사업자등록번호, 사업장명, 사업장주소, 이메일주소(문서24 상담 시)')" onmouseout="fn_mouseOut('36')">
                                                            	&nbsp;필수 : 연락처, 상담내용, 상담내용 녹취<br>
                                                                &nbsp;선택 : 성명, 주소, 신고내용(긴급신고 이관 시), 접수내용(비긴급상담 이관ㆍ접수 시)<br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td tabindex="72" onmouseover="fn_mouseOver('72','필수 : 연락처, 상담내용, IP주소, 카카오톡ID')" onmouseout="fn_mouseOut('72')">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td tabindex="81" onmouseover="fn_mouseOver('81','필수 : 연락처, 상담내용, 상담영상, IP주소')" onmouseout="fn_mouseOut('81')">
                                            ...
                                            <tr>
                                               <td style="padding-left:10px;font-size:18px;text-algin:center;">
                                                    ...
                                                    <b tabindex="90" onmouseover="fn_mouseOver('90','제3조. 개인정보 처리의 위탁')" onmouseout="fn_mouseOut('90')">제3조(개인정보처리의 위탁)</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-left:20px;font-size:18px;text-algin:center;">
                                                    ...
                                                    <b tabindex="100" onmouseover="fn_mouseOver('100','제4조(정보주체와 법정 대리인의 권리ㆍ의무 등)')" onmouseout="fn_mouseOut('100')">제4조(정보주체와 법정 대리인의 권리ㆍ의무 등)</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td tabindex="119" onmouseover="fn_mouseOver('119','고충상담기획과')" onmouseout="fn_mouseOut('119')" rowspan="6" style="text-align: center;vertical-align: middle;"> 고충상담기획과 </td>
                                                                <td tabindex="120" onmouseover="fn_mouseOver('120','02다시2110다시6502')" onmouseout="fn_mouseOut('120')" rowspan="6" style="text-align: center;vertical-align: middle;"> 02-2110-6502 </td>
                                                                <td tabindex="121" onmouseover="fn_mouseOver('121','044다시200다시7957')" onmouseout="fn_mouseOut('121')" rowspan="6" style="text-align: center;vertical-align: middle;"> 044-200-7957 </td>
                                                            </tr>
                                                            <tr>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td tabindex="145" onmouseover="fn_mouseOver('145','정부민원안내콜센터장')" onmouseout="fn_mouseOut('145')">&nbsp;정부민원안내콜센터장</td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <span tabindex="187" onmouseover="fn_mouseOver('187','2. 개인정보를 수집한 정황 또는 처리 관행에 비추어 볼 때 개인정보의 추가적인 이용 또는 제공에 대한 예측 가능성이 있는지 여부')" onmouseout="fn_mouseOut('187')" style="padding-left:27px">2. 개인정보를 수집한 정황 또는 처리 관행에 비추어 볼 때 개인정보의 추가적인 이용 또는 제공에 대한 예측 가능성이 있는지 여부</span><br>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td tabindex="211" onmouseover="fn_mouseOver('211','정부민원안내콜센터장')" onmouseout="fn_mouseOut('211')">&nbsp;정부민원안내콜센터장</td>
                                            ...
                                            <tr>
                                                <td tabindex=237 onmouseover="fn_mouseOver('237','1  이 개인정보 처리방침은 2024.4.15(월)부터 적용됩니다. 직전 개인정보처리방침에서 다음 내용이 변경되었습니다.')" onmouseout="fn_mouseOut('237')" style="padding-left:20px">
                                                    ①  이 개인정보 처리방침은 2024.4.15(월)부터 적용됩니다. 직전 개인정보처리방침에서 다음 내용이 변경되었습니다.
                                                </td>
                                            <tr>
                                            <td style="padding-left:20px;">
                                                 <table class='table table-bordered' style="font-size:14px;">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th tabindex="239" onmouseover="fn_mouseOver('239','변경 사유')" onmouseout="fn_mouseOut('239')" scope="col">변경사유</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td tabindex="240" onmouseover="fn_mouseOver('240','개인정보 처리항목 수정')" onmouseout="fn_mouseOut('240')" style="text-align: center;">개인정보 처리항목 수정</td>
                                                                <td tabindex="241" onmouseover="fn_mouseOver('241','상담업무 분야별 개인정보 처리항목 정비')" onmouseout="fn_mouseOut('241')" style="text-align: center;">상담업무 분야별 개인정보 처리항목 정비</td>
                                                            </tr>
                                                         </tbody>
                                                  </table>
                                                  </td>
