...
<body>
	<table class='layout' summary="보도자료 관리 등록">
			...
			<tr>
				...
				<td scope="col"  class='contentArea'>
					...
					<div class='page-title'>
						...
						<div class='navi'><i class='fa fa-home'></i> <i class='fa fa-chevron-right'></i> 게시물관리 <i class='fa fa-chevron-right'></i> <span class='now'>보도자료관리</span> <i class='fa fa-chevron-right'></i> <span class='now'>게시물 등록</span></div>
					</div>
					<div class="panel panel-default writeBox">
							<div class="panel-heading">게시물 등록</div>
						  	<div class="panel-body">
								<form  action="/bodo/regProc.do" method="post">
							  		<table class='table table-bordered' summary="보도자료 등록을 나타냅니다.">
							  		<caption style="display:none">보도자료관리 등록</caption>
							  			<tbody>
								  			<tr>
							  				...
							  				<tr>
								  				...
								  				<td scope="col"  colspan=3>
													<input type='text' id="EMAIL" name="EMAIL" title="이메일"  class='form-control' value="${fn:escapeXml(sUserEmail)}" placeholder="이메일을 입력해주세요">
								  				</td>
								  			</tr>
							  				<tr>
							  					<th scope="col">내용</th>
												 <td scope="col"  colspan="3">
													 <textarea id="summernote" name="CONTENT"  title="내용">
													 </textarea>
					  		...
					  		<input type='hidden' id="CONFID" name="CONFID" value="4"/>
