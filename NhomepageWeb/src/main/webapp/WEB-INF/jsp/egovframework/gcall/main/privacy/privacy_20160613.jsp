                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('29','1. 110정부민원안내콜센터는 전화상담, 문자상담, 예약상담, 에스엔에스상담, 채팅상담, 화상(수화)상담 처리를 위해 아래와 같이 개인정보를 처리합니다.')" onmouseout="fn_mouseOut('29')" style="padding-left:20px">
                                                    ① 110정부민원안내콜센터는 전화상담, 문자상담, 예약상담, SNS상담, 채팅상담, 화상(수화)상담 처리를 위해 아래와 같이 개인정보를 처리합니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td onmouseover="fn_mouseOver('45','공통항목 : 연락처(전화번호), 상담내용 , 상담내용 녹취 ,추가항목1 : 생년월일, 주소지, 가족성명, 보훈번호(국가보훈처 관련상담 시) ,추가항목2 : 성별, 지역(또는 주소), 연령대(통계청 관련상담 시) ,추가항목3 : 성명(행정심판 확인 및 조회 시) ,추가항목4 : 성명, 연락처(식품의약품안전처 관련상담 시 아웃콜 진행할 경우)')" onmouseout="fn_mouseOut('45')">
                                                            	&nbsp;공통항목 : 연락처(전화번호), 상담내용 , 상담내용 녹취<br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td onmouseover="fn_mouseOver('63','연락처, 문의내용 등')" onmouseout="fn_mouseOut('63')">&nbsp;연락처, 문의내용 등</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td onmouseover="fn_mouseOver('101','1년')" onmouseout="fn_mouseOut('101')">&nbsp;1년</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('102','화상(수화)상담')" onmouseout="fn_mouseOut('102')" colspan="2">&nbsp;<b>화상(수화)상담</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('103','처리목적')" onmouseout="fn_mouseOut('103')" style="text-align: center;">처리목적</td>
                                                            <td onmouseover="fn_mouseOver('104','화상(수화) 상담업무 처리 및 분석ㆍ관리')" onmouseout="fn_mouseOut('104')">&nbsp;화상(수화) 상담업무 처리 및 분석ㆍ관리</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('105','처리항목')" onmouseout="fn_mouseOut('105')" style="text-align: center;">처리항목</td>
                                                            <td onmouseover="fn_mouseOver('106','공통항목 : 연락처, 상담내용, 화상상담 영상, 아이피주소  추가항목 : 성명 타 기관으로 상담내용 처리이관 시')" onmouseout="fn_mouseOut('106')">&nbsp;공통항목 : 연락처, 상담내용, 화상상담 영상, IP주소<br>
                                                                &nbsp;추가항목 : 성명(타 기관으로 상담내용 처리이관 시)</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('107','처리근거')" onmouseout="fn_mouseOut('107')" style="text-align: center;">처리근거</td>
                                                            <td onmouseover="fn_mouseOver('108','부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령')" onmouseout="fn_mouseOut('108')">&nbsp;부패방지 및 국민권익위원회 설치 및 운영에 관한 법률 및 동법 시행령</td>
                                                        </tr>
                                                        <tr>
                                                            <td onmouseover="fn_mouseOver('109','보유기간')" onmouseout="fn_mouseOut('109')" style="text-align: center;">보유기간</td>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('121','3. 110정부민원안내콜센터는 대국민 서비스 제공 및 민원처리 등 법령에서 정한 소관업무 수행의 목적에 필요한 최소한의 개인정보만을 처리합니다')" onmouseout="fn_mouseOut('121')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('122','2. 개인정보처리 및 제3자 제공')" onmouseout="fn_mouseOut('122')">
                                                    <b>2. 개인정보처리 및 제3자 제공</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('123','1. 110정부민원안내콜센터는 원칙적으로 명시한 범위 내에서 개인정보를 처리하며, 정보주체의 사전 동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다.')" onmouseout="fn_mouseOut('123')" style="padding-left:20px">
                                                    ① 110정부민원안내콜센터는 원칙적으로 명시한 범위 내에서 개인정보를 처리하며, 정보주체의 사전 동의 없이는 본래의 목적 범위를 초과하여 처리하거나 제3자에게 제공하지 않습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('124','2. 다만, 다른 법률에 특별한 규정이 있는 경우 또는 개인정보보호법 제18조제2항에 해당하는 경우에는 제3자에게 제공할 수 있습니다.')" onmouseout="fn_mouseOut('124')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('125','3. 개인정보 처리의 위탁')" onmouseout="fn_mouseOut('125')">
                                                    <b>3. 개인정보 처리의 위탁</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('126','1. 110정부민원안내콜센터는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.')" onmouseout="fn_mouseOut('126')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th onmouseover="fn_mouseOver('127','위탁내용')" onmouseout="fn_mouseOut('127')" scope='col'>
                                                                    	위탁내용
                                                                </th>
                                                                <th onmouseover="fn_mouseOver('128','위탁기간')" onmouseout="fn_mouseOut('128')" scope='col'>
                                                                    	위탁기간
                                                                </th>
                                                                <th onmouseover="fn_mouseOver('129','위탁(수탁)업체')" onmouseout="fn_mouseOut('129')" scope='col'>
                                                                   	 위탁(수탁)업체
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('130','전산자원 유지관리 및 위탁운영')" onmouseout="fn_mouseOut('130')" style="text-align: center;">
                                   									전산자원<br>유지관리 <br>및 <br>위탁운영
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('140','2016년3월1일 에서 2016년12월31일')" onmouseout="fn_mouseOut('140')" style="text-align: center;">
                                                                    &nbsp;2016.3.1<br>~2016.12.31
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('141','업체 : 주식회사 아리시스 주소 : 서울특별시 금천구 가산디지털1로 145, 에이스하이엔드타워3 1102호 전화 : 02-2177-8100 근무시간 : 09:00~18:00(평일) 토ㆍ일요일 및 공휴일 휴무')" onmouseout="fn_mouseOut('141')">
                                                                    &nbsp;업체 : 주식회사 아리시스<br>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('142','제1콜센터 위탁운영')" onmouseout="fn_mouseOut('142')" rowspan="2" style="text-align: center;">
                                                                 	제1콜센터<br>위탁운영
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('143','2015년2월1일 에서 2016년12월31일')" onmouseout="fn_mouseOut('143')" rowspan="2" style="text-align: center;">
                                                                    &nbsp;2015.2.1<br>~2016.12.31

                                                                </td>
                                                                <td onmouseover="fn_mouseOver('144','기관명 : 주식회사 케이티스 주소 : 서울특별시 영등포구 여의대로 14, KT빌딩 10층     (여의도동) 전화 : 02-3215-2140 근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일) 일요일 휴무')" onmouseout="fn_mouseOut('144')">
                                                                    &nbsp;기관명 : 주식회사 케이티스<br>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('145','기관명 : ㈜엠.피.씨 주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동) 전화 : 02-3401-4114 근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일) 일요일 휴무')" onmouseout="fn_mouseOut('145')">
                                                                    &nbsp;기관명 : ㈜엠.피.씨<br>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('146','제2콜센터 위탁운영')" onmouseout="fn_mouseOut('146')" style="text-align: center;">
                                             						제2콜센터<br>위탁운영
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('147','2016년6월1일 에서 2018년12월31일')" onmouseout="fn_mouseOut('147')" style="text-align: center;">
                                                                    &nbsp;2016.6.1.<br>~2018.12.31
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('148','기관명 : ㈜엠.피.씨 주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동) 전화 : 02-3401-4114 근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일) 일요일 휴무')" onmouseout="fn_mouseOut('148')">
                                                                    &nbsp;기관명 : ㈜엠.피.씨<br>
                                                                    &nbsp;주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동)<br>
                                                                    &nbsp;전화 : 02-3401-4114<br>
                                                                    &nbsp;근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일)<br>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('149','제2콜센터 시설임차')" onmouseout="fn_mouseOut('149')" style="text-align: center;">
                                  									제2콜센터<br>시설임차
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('150','2016년6월1일에서 2018년12월31일')" onmouseout="fn_mouseOut('150')" style="text-align: center;">
                                                                    &nbsp;2016.6.1.<br>~2018.12.31
                                                                </td>
                                                                <td onmouseover="fn_mouseOver('160','기관명 : ㈜엠.피.씨 주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동) 전화 : 02-3401-4114 근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일) 일요일 휴무')" onmouseout="fn_mouseOut('160')">
                                                                    &nbsp;기관명 : ㈜엠.피.씨<br>
                                                                    &nbsp;주소 : 서울특별시 강남구 광평로 280, 로즈데일빌딩 9층    (수서동)<br>
                                                                    &nbsp;전화 : 02-3401-4114<br>
                                                                    &nbsp;근무시간 : 09:00~18:00(평일), 09:00~13:00(토요일)<br>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('161','2. 110정부민원안내콜센터는 위탁계약 체결 시 개인정보보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적ㆍ관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리ㆍ감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.')" onmouseout="fn_mouseOut('161')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('169','2. 제1에 따른 권리 행사는 개인정보보호법 시행규칙 별지 제8호 및 제11호 서식에 따라 작성 후 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며, 110정부민원안내콜센터에서는 요구를 한 자가 본인이거나 정당한 대리인인지 확인합니다.')" onmouseout="fn_mouseOut('169')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('183','110정부민원안내콜센터는 개인정보 처리에 관한 업무를 책임지고 정보주체의 불만 또는 피해구제 등을 위하여 다음과 같이 개인정보보호 책임자 및 담당자를 지정하고 있습니다.')" onmouseout="fn_mouseOut('183')" style="padding-left:20px">
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('187','윤남기')" onmouseout="fn_mouseOut('187')">&nbsp;윤남기</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('204','110정부민원안내콜센터장')" onmouseout="fn_mouseOut('204')">&nbsp;110정부민원안내콜센터장</td>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('225','1. 110정부민원안내콜센터는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 해당 정보를 재생할 수 없는 기술적 방법을 사용하여 파기합니다. 다만, 다른 법률에 따라 보존하여야 하는 경우에는 그러하지 아니합니다.')" onmouseout="fn_mouseOut('225')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <span onmouseover="fn_mouseOver('228','110정부민원안내콜센터에서는 파기하여야 하는 개인정보(또는 개인정보파일)에 대해 개인정보파기 계획을 수립하여 파기합니다. 파기 사유가 발생한 개인정보(또는 개인정보파일)를 정하고, 개인정보보호책임자의 승인을 받아 개인정보(또는 개인정보파일)을 파기합니다')" onmouseout="fn_mouseOut('228')" style="padding-left:27px"> 110정부민원안내콜센터에서는 파기하여야 하는 개인정보(또는 개인정보파일)에 대해 개인정보파기 계획을 수립하여 파기합니다. 파기 사유가 발생한 개인정보(또는 개인정보파일)를 정하고, 개인정보보호책임자의 승인을 받아 개인정보(또는 개인정보파일)을 파기합니다.</span><br>
                                                    <span onmouseover="fn_mouseOver('229','2. 파기방법')" onmouseout="fn_mouseOut('229')" style="padding-left:25px">2. 파기방법 </span><br>
                                                    <span onmouseover="fn_mouseOver('230','110정부민원안내콜센터에서는 전자적 파일 형태로 기록ㆍ저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록ㆍ저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다')" onmouseout="fn_mouseOut('230')" style="padding-left:27px"> 110정부민원안내콜센터에서는 전자적 파일 형태로 기록ㆍ저장된 개인정보는 기록을 재생할 수 없도록 파기하며, 종이 문서에 기록ㆍ저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다. </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td >
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('241','110정부민원안내콜센터는 개인정보의 안전성 확보를 위하여 다음과 같은 조치를 하고 있습니다')" onmouseout="fn_mouseOut('241')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('250','2. 또한, 개인정보의 열람, 정정, 삭제, 처리정지 등에 대한 정보주체의 요구에 대한 처분 또는 부작위로 인하여 권리 또는 이익을 침해받은 경우, 행정심판법이 정하는 바에 따라 행정심판(더블더블더블점심판점지오점케이알)을 청구할 수 있습니다.')" onmouseout="fn_mouseOut('250')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('261','1. 110정부민원안내콜센터는 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다.')" onmouseout="fn_mouseOut('261')" style="padding-left:20px">
                                                    ① 110정부민원안내콜센터는 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span onmouseover="fn_mouseOver('262','1. 설치목적 : 시설안전 및 화재예방')" onmouseout="fn_mouseOut('262')" style="padding-left:25px">1. 설치목적 : 시설안전 및 화재예방 </span><br>
                                                    <span onmouseover="fn_mouseOver('263','2. 설치대수 : 3대 ')" onmouseout="fn_mouseOut('263')" style="padding-left:25px">2. 설치대수 : 3대 </span><br>
                                                    <span onmouseover="fn_mouseOver('264','3. 설치위치 : 110정부민원안내콜센터 전산실')" onmouseout="fn_mouseOut('264')" style="padding-left:25px">3. 설치위치 : 110정부민원안내콜센터 전산실 </span><br>
                                                    <span onmouseover="fn_mouseOver('265','4. 촬영범위 : 110정부민원안내콜센터 전산실 입구 및 내부')" onmouseout="fn_mouseOut('265')" style="padding-left:25px">4. 촬영범위 : 110정부민원안내콜센터 전산실 입구 및 내부 </span><br>
                                                    <span onmouseover="fn_mouseOver('266','5. 촬영시간 : 24시간')" onmouseout="fn_mouseOut('266')" style="padding-left:25px">5. 촬영시간 : 24시간 </span><br>
                                                    <span onmouseover="fn_mouseOver('267','6. 보관기간 : 22일')" onmouseout="fn_mouseOut('267')" style="padding-left:25px">6. 보관기간 : 22일 </span><br>
                                                    <span onmouseover="fn_mouseOver('268','7. 보관장소 : 110정부민원안내콜센터 전산실')" onmouseout="fn_mouseOut('268')" style="padding-left:25px">7. 보관장소 : 110정부민원안내콜센터 전산실 </span><br>
                                                    <span onmouseover="fn_mouseOver('269','8. 관리책임 : 110정부민원안내콜센터장')" onmouseout="fn_mouseOut('269')" style="padding-left:25px">8. 관리책임 : 110정부민원안내콜센터장 </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('270','2. 정보주체는 위 영상정보처리기기에 대해 열람ㆍ존재확인 청구서를 이용하여 관리책임자에게 개인영상정보 열람을 신청할 수 있습니다.')" onmouseout="fn_mouseOut('270')" style="padding-left:20px">
                                                    ② 정보주체는 위 영상정보처리기기에 대해 열람ㆍ존재확인 청구서를 이용하여 관리책임자에게 개인영상정보 열람을 신청할 수 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('280','3. 다만, 정보주체 자신이 촬영된 경우나 정보주체의 생명ㆍ신체ㆍ재산 이익을 위해 명백히 필요한 경우에 한하여 열람을 허가합니다.')" onmouseout="fn_mouseOut('280')" style="padding-left:20px">
                                                    ③ 다만, 정보주체 자신이 촬영된 경우나 정보주체의 생명ㆍ신체ㆍ재산 이익을 위해 명백히 필요한 경우에 한하여 열람을 허가합니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('281','4. 위 영상정보처리기기는 접근통제 및 권한제한, 안전한 저장ㆍ전송기술 적용, 처리기록 보관 및 위ㆍ변조 방지장치, 보관시설 마련 및 잠금장치 설정 등으로 보호조치 되고 있습니다.')" onmouseout="fn_mouseOut('281')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('282','10. 개인정보 처리방침의 변경')" onmouseout="fn_mouseOut('282')">
                                                    <b>10. 개인정보 처리방침의 변경</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('283','1. 이 개인정보 처리방침은 2016.6.13(월)부터 적용됩니다')" onmouseout="fn_mouseOut('283')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2016.6.13(월)부터 적용됩니다.
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
