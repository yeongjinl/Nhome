...
<script type="text/javascript">
	alert("비밀번호 유효기간이 만료되어 비밀번호를 수정합니다.");
</script>
</head>
<body>
	<div class='loginPage'>
		<div class='loginWrap'>
			...
			<div class='box'>
				...
				<div class='subtitle'>비밀번호 유효기간이 만료되어 비밀번호를 수정합니다.</div>

				<div class='label'><label for="now_pw">현재 비밀번호</label></div>
				<input type='password' name='now_pw' id='now_pw' class='form-control input-lg'>

				<div class='label'><label for="pw">새 비밀번호</label></div>
				<input type='password' name='pw' id='pw' class='form-control input-lg'>

				<div class='label clear'><label for="pwChk">새 비밀번호 확인</label></div>
