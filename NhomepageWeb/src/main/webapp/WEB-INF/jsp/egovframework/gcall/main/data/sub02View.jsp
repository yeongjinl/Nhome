            ...
            <main>
                <div class='contentArea' id='contentArea'>
                    <div class='limitWrap'>
                        ...
                        <div class='mainTitle'>상담사연</div>
                        
                        <table class='table table-bordered boardView'>
                            <caption class='blind'>상담사연 상세정보</caption>
                            <thead></thead>
                            <tbody>
                                <tr>
                                    <th>작성일</th>
                                    <td>${storyDetail.BOARD_REG_DATE}</td>

                                    <th>조회수</th>
                                    <td>${storyDetail.BOARD_VIEW}</td>
                                </tr>
                                ...
                                <tr>
                                    <th class='ttl'>제목</th>
                                    <td colspan="3" class='ttl'>${storyDetail.BOARD_TITLE}</td>
                                    
                                </tr>
                                
                                <tr>
                                    <td colspan="4" class='cont'>${storyDetail.BOARD_CONTENTS}</td>
                                </tr>
                                ...
                                <c:if test="${storyNext != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/data/storyView.do?num=${storyNext.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${storyNext.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                                <c:if test="${storyPrev != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/data/storyView.do?num=${storyPrev.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${storyPrev.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                            </tbody>
                        ...
                        <div class='text-center boardBtnWrap'>
                            <button type='button' class='btn' onclick="location.href='<c:url value='/data/story.do?curPage=${curPage}&scType=${scType}&scText=${scText}'/>'">목록</button>
                        </div>
