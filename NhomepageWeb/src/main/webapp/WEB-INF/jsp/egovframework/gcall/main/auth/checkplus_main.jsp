...
<%
    ...
    String sReturnUrl = "https://localhost:8449/auth3/checkplus_success.do";      // 성공시 이동될 URL
    String sErrorUrl = "https://localhost:8449/auth3/checkplus_fail.do";          // 실패시 이동될 URL
