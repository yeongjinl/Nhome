...
<body>
	<table class='layout' summary="홍보자료 관리 등록">
			...
			<tr>
				...
				<td scope="col"  class='contentArea'>
					...
					<div class='page-title'>
						...
						<div class='navi'><i class='fa fa-home'></i> <i class='fa fa-chevron-right'></i> 게시물관리 <i class='fa fa-chevron-right'></i> <span class='now'>홍보자료	관리</span> <i class='fa fa-chevron-right'></i> <span class='now'>게시물 등록</span></div>
					</div>
					<div class="panel panel-default writeBox">
							<div class="panel-heading">게시물 등록</div>
						  	<div class="panel-body">
								<form  action="/promotion/regProc.do" method="post">
							  		<table class='table table-bordered' summary="홍보자료 등록을 나타냅니다.">
							  		<caption style="display:none">홍보자료관리 등록</caption>
							  			<tbody>
								  			<tr>
