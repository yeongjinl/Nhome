                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20190401">2019.04.01 ~ 2019.06.09 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                                ...
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('151','과천센터 위탁운영')" onmouseout="fn_mouseOut('151')" style="text-align: center;">
                                                                    	과천센터<br>위탁운영
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('156','2019.4.1~2019.12.31')" onmouseout="fn_mouseOut('156')" style="text-align: center;">
                                                                    &nbsp;2019.4.1<br>~2019.12.31
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('159','2019.4.1~2019.12.31')" onmouseout="fn_mouseOut('159')" style="text-align: center;">
                                                                    &nbsp;2019.4.1<br>~2019.12.31
                                                                </td>
                                            ...
                                            <tr>
                                                <td style="padding-left:20px">
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th onmouseover="fn_mouseOver('184','개인정보보호 책임자')" onmouseout="fn_mouseOut('184')" scope="col" colspan="2" >개인정보보호 책임자</th>
                                                                <th onmouseover="fn_mouseOver('185','개인정보보호 담당자')" onmouseout="fn_mouseOut('185')" scope="col" colspan="2" >개인정보보호 담당자</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                                                <td onmouseover="fn_mouseOver('186','성명')" onmouseout="fn_mouseOut('186')" style="text-align: center;">성명</td>
                                                                <td onmouseover="fn_mouseOver('187','전시현')" onmouseout="fn_mouseOut('187')">&nbsp;전시현</td>
                                                                <td onmouseover="fn_mouseOver('188','성명')" onmouseout="fn_mouseOut('188')" style="text-align: center;">성명</td>
                                                                <td onmouseover="fn_mouseOver('189','정진덕')" onmouseout="fn_mouseOut('189')">&nbsp;정진덕</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('208','02-2110-6506 개인정보보호 담당자로 연결')" onmouseout="fn_mouseOut('208')" rowspan="3">&nbsp;02-2110-6506<br>※ 개인정보보호 담당자로 연결</td>
                                                                <td onmouseover="fn_mouseOver('209','연락처')" onmouseout="fn_mouseOut('209')" style="text-align: center;">연락처</td>
                                                                <td onmouseover="fn_mouseOver('210','02-2110-6506')" onmouseout="fn_mouseOut('210')">&nbsp;02-2110-6506</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('223','엔에이에스비엔아이비@케이오알이에이점케이알')" onmouseout="fn_mouseOut('223')">&nbsp;nasbnib@korea.kr</td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot></tfoot>
                                                    </table>
                                            ...
                                            <tr>
                                                <td style="padding-left:45px">		
                                                    <table class='table table-bordered' >
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th onmouseover="fn_mouseOver('280','구분')" onmouseout="fn_mouseOut('280')" scope="col" colspan="2">구분</th>
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('345','1. 이 개인정보 처리방침은 2019.4.1(일)부터 적용됩니다')" onmouseout="fn_mouseOut('345')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2019.4.1(일)부터 적용됩니다.
                                                </td>										
                                            </tr>
                                        </tbody>
                                        <tfoot></tfoot>
