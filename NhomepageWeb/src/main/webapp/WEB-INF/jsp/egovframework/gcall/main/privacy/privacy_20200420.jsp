                    ...
                    <div class='limitWrap'>
                        ...
                        <h3 onmouseover="fn_mouseOver('26','국민콜110(정부민원안내) 개인정보처리방침')" onmouseout="fn_mouseOut('26')" class='mainTitle'>국민콜110(정부민원안내) 개인정보처리방침</h3>
							...
							<div class='text-right'>
									...
									<option selected="selected" value="/privacy.do?sd=20200420">2020.04.20 ~ 2021.01.31 적용지침</option>
                                ...
                                <div class="panel-body ">
                                    <table>
                                        ...
                                        <tbody>
                                                    ...
                                                    <table class='table table-bordered'>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('140','2020.3.25~2021.12.31')" onmouseout="fn_mouseOut('140')" style="text-align: center;">
                                                                    &nbsp;2020.3.25<br>~2021.12.31
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td onmouseover="fn_mouseOver('155','2020.4.10~2020.12.31')" onmouseout="fn_mouseOut('155')" style="text-align: center;">
                                                                    &nbsp;2020.4.10<br>~2020.12.31
                                            ...
                                            <tr>
                                                <td>
                                                    <span onmouseover="fn_mouseOver('286','1. 개인정보보호 종합포털 : 국번없이 118(프라이버시점기사점오알점케이알)')" onmouseout="fn_mouseOut('286')" style="padding-left:25px">1. 개인정보보호 종합포털 : 국번없이 118(privacy.kisa.or.kr) </span><br>
                                                    <span onmouseover="fn_mouseOver('287','2. 대검찰청 사이버범죄수사단 : 02-3480-3571(사이버시드골뱅이에스피오점지오점케이알)')" onmouseout="fn_mouseOut('287')" style="padding-left:25px">2. 대검찰청 사이버범죄수사단 : 02-3480-3571(cybercid@spo.go.kr) </span><br>
                                                    <span onmouseover="fn_mouseOver('288','3. 경찰청 사이버테러대응센터 : 1566-0112(떠블떠블떠블점네탄점지오점케이알)')" onmouseout="fn_mouseOut('288')" style="padding-left:25px">3. 경찰청 사이버테러대응센터 : 1566-0112(www.netan.go.kr) </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('289','2. 또한, 개인정보의 열람, 정정, 삭제, 처리정지 등에 대한 정보주체의 요구에 대한 처분 또는 부작위로 인하여 권리 또는 이익을 침해받은 경우, 행정심판법이 정하는 바에 따라 행정심판(더블더블더블점심판점지오점케이알)을 청구할 수 있습니다')" onmouseout="fn_mouseOut('289')" style="padding-left:20px">
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('290','9. 영상정보처리기기 설치 및 운영')" onmouseout="fn_mouseOut('290')">
                                                    <b>9. 영상정보처리기기 설치 및 운영</b><br> 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('291','1. 국민콜110은 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다')" onmouseout="fn_mouseOut('291')" style="padding-left:20px">
                                                    ① 국민콜110은 다음과 같이 영상정보처리기기를 설치ㆍ운영하고 있습니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('292','1. 설치목적 : 국민콜110 전산실 안전 및 화재예방 등')" onmouseout="fn_mouseOut('292')">
                                                    <span style="padding-left:25px">1. 설치목적 : 국민콜110 전산실 안전 및 화재예방 등 </span><br>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td onmouseover="fn_mouseOver('293','2. 설치대수 : 3대')" onmouseout="fn_mouseOut('293')">		
                                                    <span style="padding-left:25px">2. 설치대수 : 3대 </span><br>
                                                </td>
                                            </tr>
                                            <tr>	
                                                <td onmouseover="fn_mouseOver('294','3. 설치위치 : 국민콜110 전산실')" onmouseout="fn_mouseOut('294')">	
                                            ...
                                            <tr>
                                                <td onmouseover="fn_mouseOver('375','1. 이 개인정보 처리방침은 2020.4.20(월)부터 적용됩니다')" onmouseout="fn_mouseOut('375')" style="padding-left:20px">
                                                    ① 이 개인정보 처리방침은 2020.4.20(월)부터 적용됩니다.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td >
