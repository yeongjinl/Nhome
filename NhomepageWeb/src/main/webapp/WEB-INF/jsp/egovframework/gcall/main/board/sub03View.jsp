            ...
            <main>
                <div class='contentArea' id='contentArea'>
                    <div class='limitWrap'>
                        ...
                        <div class='mainTitle'>홍보자료</div>
                        
                        <table class='table table-bordered boardView'>
                            <caption class='blind'>홍보자료 상세정보</caption>
                            <thead></thead>
                            <tbody>
                                <tr>
                                    <th>작성일</th>
                                    <td>${promotionDetail.BOARD_REG_DATE}</td>

                                    <th>조회수</th>
                                    <td>${promotionDetail.BOARD_VIEW}</td>
                                </tr>
                                ...
                                <tr>
                                    <th class='ttl'>제목</th>
                                    <td colspan="3" class='ttl'>${promotionDetail.BOARD_TITLE}</td>
                                </tr>
                                
                                <tr>
                                    <td colspan="4" class='cont'>${promotionDetail.BOARD_CONTENTS}</td>
                                </tr>
                                ...
                                <c:if test="${promotionNext != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/board/promotionView.do?num=${promotionNext.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${promotionNext.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                                <c:if test="${promotionPrev != null}">
                                    <tr>
                                        ...
                                        <td colspan="3" class='prevnext'>
                                            <a href="<c:url value='/board/promotionView.do?num=${promotionPrev.BOARD_NUM}&curPage=${curPage}&scType=${scType}&scText=${scText}'/>">${promotionPrev.BOARD_TITLE}</a>
                                        </td>
                                    </tr>
                                </c:if>
                            </tbody>
                        ...
                        <div class='text-center boardBtnWrap'>
                            <button type='button' class='btn' onclick="location.href='<c:url value='/board/promotion.do?curPage=${curPage}&scType=${scType}&scText=${scText}'/>'">목록</button>
                        </div>
