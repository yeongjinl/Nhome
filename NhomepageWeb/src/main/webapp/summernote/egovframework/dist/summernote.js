  ...
  $$1.extend($$1.summernote.lang, {
      'en-US': {
          ...
          image: {
              ...
              selectFromFiles: '이미지 / 동영상 파일을 선택해주세요',
              maximumFileSize: 'Maximum file size',
              maximumFileSizeError: 'Maximum file size exceeded.',
              url: '이미지 주소를 복사해 붙여주세요',
              remove: 'Remove Image',
              original: 'Original'
          },
          video: {
          ...
          link: {
              ...
              unlink: '링크 해제',
              edit: '편집 하기',
              textToDisplay: '화면에 표시할 텍스트 ',
              url: '연결할 링크의 주소를 복사해 붙여넣어 주세요'
              //openInNewWindow: '새창띄우기'
          },
          table: {
              table: '표',
...
//              ,codeview: 'html 코드 보기'
          ...
          color: {
              ...
              foreground: '전경색',
              transparent: '투명도',
              setTransparent: '투명도 설정',
              reset: '리셋',
              resetToDefault: '기본으로 리셋',
              cpSelect: '선택'
          },
          shortcut: {
