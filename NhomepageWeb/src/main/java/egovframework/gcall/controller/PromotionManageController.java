...
public class PromotionManageController {
	...
	public ModelAndView list(
		...
		String promotionAuth = CmmUtil.nvl((String) authUI.get("PROMOTION_AUTH"));
		String userType = CmmUtil.nvl((String) authUI.get("USER_TYPE"));
		if(promotionAuth.equals("1")||userType.equals("0")) {
			...
			mv.setViewName("egovframework/gcall/boardManage/promotionManage/promotionList");
	...
	public ModelAndView reg(HttpSession session) {
		...
		if(session.getAttribute("ss_user_auth")!=null) {
			...
			String userType = CmmUtil.nvl((String) authUI.get("USER_TYPE"));
			if(promotionAuth.equals("1")||userType.equals("0")) {
				mv.setViewName("egovframework/gcall/boardManage/promotionManage/promotionReg");
			}else{
				mv.setViewName("egovframework/gcall/boardManage/redirect");
				mv.addObject("url","/g110/adm.do");
				mv.addObject("msg","권한이 없습니다.");
	...
	public ModelAndView regProc(BoardCommonDTO bDTO,
		...
		if(session.getAttribute("ss_user_info")!=null) {
			...
			if(promotionAuth.equals("1")||userType.equals("0")) {
		    	...
		    	mv.setViewName("redirect:/promotion/list.do");
		    	bDTO=null;
			}else {
				mv.setViewName("egovframework/gcall/boardManage/redirect");
				mv.addObject("url","/g110/adm.do");
	...
	public ModelAndView detail(HttpServletRequest req,HttpSession session) throws Exception {
		...
		if(session.getAttribute("ss_user_info")!=null) {
			...
			if(promotionAuth.equals("1")||userType.equals("0")) {
				...
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_NUM"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("CONF_ID"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("USER_ID"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_TITLE"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_WRITER"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_EMAIL"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_CONTENTS"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_IP"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_VIEW"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_REG_DATE"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("IS_TOP"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("WRITE_PATH"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("IS_SOMENEIL"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("SOMENEIL_IMG_PATH"));
				System.out.println(" boardService.getBoardDetail hmap : " + hMap.get("BOARD_PW"));
				...
				mv.setViewName("egovframework/gcall/boardManage/promotionManage/promotionDetail");
	...
	public ModelAndView updateView(HttpServletRequest req,HttpSession session) throws JSONException {
		...
		if(promotionAuth.equals("1")||userType.equals("0")) {
			...
			JSONObject jsonObj = new JSONObject(hMap);
			JSONArray jsonFList = new JSONArray(fList);
			mv.setViewName("egovframework/gcall/boardManage/promotionManage/promotionUpdate");
			mv.addObject("jsonObj", jsonObj);
			mv.addObject("fList", jsonFList);
			mv.addObject("newFList",newFList);
			hMap=null;
	...
	public ModelAndView deleteBoard(HttpServletRequest req,HttpSession session) {
		...
		mv.setViewName("egovframework/gcall/boardManage/redirect");
		mv.addObject("url","/promotion/list.do");
