...
public class DateTimeUtil {
	 ...
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 format 에 맞지 않는 경우.
	 **/
	 ...
	 * @throws java.text.ParseException 인자로 전달된 시각이 지정된 포멧("HH:mm" or "HH/mm" 에) 맞지 않거나 올바른 시간이 아닐경우 발생. 
	 */
	...
	*/
	 ...
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 spattern format 에 맞지 않는 경우.
	 */
	...
	* </pre></blockquote>
	 ...
	 * </pre>
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이  "yyyyMMdd" 형식에 맞지 않는 경우.
	 *
	 */
	public static int whichDay(String s) throws java.text.ParseException {
				return whichDay(s, "yyyy-MM-dd");
	}
	 ...
	 *          7: 토요일 (java.util.Calendar.SATURDAY)
	 * </pre>
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이  format 형식에 맞지 않는 경우.
	 */
	 ...
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyyMMdd"</code> 형식에 맞지 않는 경우.
	 */
 ...
 * <p>현재시각에서 23시간 후를 표현하는 문자열 얻어오는  코드 사용예:
	 ...
	 * @exception java.text.ParseException 잘못된 날짜이거나. 날짜를 표현하는 문자열이 <code>"yyyy/MM/dd HH:mm"</code> 형식에 맞지 않는 경우.
	 */
